...
CREATE TABLE IF NOT EXISTS feeds (
                                     ...
                                     PRIMARY KEY (feed_id),
                                     FOREIGN KEY (user_challenge_id, user_id) REFERENCES user_challenges (user_challenge_id, user_id)
);

CREATE TABLE IF NOT EXISTS feed_projections (
                                   feed_id	BIGINT	NOT NULL,
                                   challenge_category	BIGINT	NOT NULL,
                                   challenge_title	VARCHAR(255)	NOT NULL,
                                   user_name	VARCHAR(255)	NOT NULL,
                                   user_profile_image_url	TEXT	NULL,
                                   user_now_max_consecutive_participation_days	BIGINT	NULL,
