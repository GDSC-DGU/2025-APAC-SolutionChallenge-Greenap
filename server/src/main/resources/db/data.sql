...
(challenge_id, challenge_category_id, title, pre_description, description, certification_method_description, status, main_image_url, certification_example_image_url, created_at, updated_at, deleted_at)
VALUES
    (1,
     1,
     '유휴 전원 / 대기 전력 OFF',
