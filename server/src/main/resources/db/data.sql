...
(challenge_id, challenge_category_id, title, pre_description, description, certification_method_description, main_image_url, certification_example_image_url, created_at, updated_at, deleted_at)
VALUES
    (1,
     1,
     '유휴 전원 / 대기 전력 OFF',
     '대기 전력 차단으로 에너지를 절약할 수 있습니다.',
     ...
     NULL, NULL, '2025-04-21 00:00:00', '2025-04-21 00:00:00', NULL),
    (2,
     1,
     '배달 일회용품 줄이기 챌린지',
     '배달 음식의 일회용품을 줄일 수 있습니다.',
    ...
    (3,
     1,
     '에어컨, 난방 끄고 환기 시키기 챌린지',
     '에어컨과 난방을 끄고 환기 시킬 수 있습니다.',
...
텀블러 하나로 1년에 약 300개 이상의 일회용 컵 사용을 줄일 수 있으며, 이는 물 수천 리터와 나무 수십 그루의 자원을 보호하는 효과로 이어집니다.',
    ...
    (9,
     2,
     '지류 영수증 말고 전자 영수증 받기 챌린지',
     '지류 영수증 대신 전자 영수증을 받습니다.',
...
INSERT INTO users (user_id, nickname, email, profile_image_url, now_max_consecutive_participation_day_count, refresh_token, created_at, updated_at, deleted_at)
VALUES (
        1,
        'testUser',
        'testEmail@email.com',
